...
SUBROUTINE  HPLANE_1_VELOCITY
  ...
  USE PML         , ONLY:                                              &
           ...
           ODD2_XL ,                     ODD2_XH ,                     &
                              ...
                              GZXL  , GZXH
  USE INTERFACES  , ONLY:                                              &
                          INH_V_UV_INT      , INH_QX_INT         ,     &
                          INH_V_QX_INT_1_SI , INH_W_QZ_INT_1_SI  ,     &
                          INH_V_W_INT_1     , INH_V_QZ_INT_1     ,     &
                          INH_V_U_2ND       , INH_V_W_2ND        ,     &
                          INH_QX_2ND       , INH_QZ_2ND          ,     &
                          STO_QXP           ,  STO_QZP           ,     &
                          STO_BOR
...
IF (STRESS_IMAGING) THEN
  ...
  CALL INH_V_QX_INT_1_SI                                               &
                     ( MXL = X_MIN_D, MXH = X_MAX_D, MXT = MX ,        &
                       MZL = Z_MIN_D, MZH = Z_MAX_D,                   &
                       X_MIN = X_MIN , X_MAX = X_MAX , TPML = TPML,    &
                       UT = UM, WT = WM,                               &
                       QXT = QX, QZT = QZ                              )

  CALL INH_W_QZ_INT_1_SI                                               &
                     ( MXL = X_MIN_D, MXH = X_MAX_D, MXT = MX ,        &
                       MZL = Z_MIN_D, MZH = Z_MAX_D,                   &
                        X_MIN = X_MIN , X_MAX = X_MAX , TPML = TPML,   &
                       JMT = JM ,                                      &
...
ELSE
  ...
  CALL  INH_QX_INT                                                                &
              ( L = L, MXL = X_MIN_D, MXH = X_MAX_D, MXT = MX ,                     &
                       MZL = Z_MIN_D, MZH = Z_MAX_D,                                &
                        X_MIN = X_MIN , X_MAX = X_MAX ,                             &
                       JMT = JM ,                                                   &
  ...
  CALL  INH_QX_2ND                                                                   &
              ( L = L, MXL = X_MIN_D, MXH = X_MAX_D, PL  = PMLL,                     &
